...
-- updated schema:
-- records table with title, duration in seconds, release date, album
-- artists table with name
-- songs_artists table with each song's artist(s)
-- producers table with names
-- producer_songs table with each song's producer(s)
...
CREATE TABLE records_producers
(
  id SERIAL PRIMARY KEY,
  record_id INTEGER REFERENCES records,
